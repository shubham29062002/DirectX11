	...
	phi(adist(rng))
{
	...
	if (!IsStaticInitialized())
	{
		...
		model.vertices[0].color = { 255,0,0,0 };
		model.vertices[1].color = { 0,255,0,0 };
		model.vertices[2].color = { 0,0,255,0 };
		model.vertices[3].color = { 255,255,0,0 };
		model.vertices[4].color = { 0,255,255,0 };
		model.vertices[5].color = { 255,0,255,0 };
